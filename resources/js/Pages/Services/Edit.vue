    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <form method="post" @submit.prevent="submit">
                <h2 class="text-left">Update Service</h2>
                ...
                <div class="form-group">
                    ...
                    <img :src="image_url" width="100" height="80" v-if="image_url" />
...
export default {
    ...
    setup() {
        ...
        // retrieve post prop
        const {title, description, image_url, id } = usePage().props.value.service;
        form.title = title;
        ...
        function submit() {
            Inertia.post(route('service.update', {'id': id}), form, {
                forceFormData: true
            });
        }
