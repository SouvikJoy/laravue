    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <form method="post" @submit.prevent="submit">
                <h2 class="text-left">Update Category</h2>
...
export default {
    ...
    setup() {
        ...
        // retrieve post prop
        const {title, slug, description, image_url, id } = usePage().props.value.category;
        form.title = title;
        form.slug = slug;
        ...
        function submit() {
            Inertia.post(route('category.update', {'id': id}), form, {
                forceFormData: true
            });
        }
